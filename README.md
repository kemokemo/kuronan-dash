...
タイトル画面です。`Space`キーでキャラクター選択画面へと進みます。
...
コースをダッシュで走り抜けます。`Space`キーでゲームを開始します。
キーボードの矢印キーの上下でレーンを移動しながら進み、タイムがゼロになる前にゴールまでたどり着けたらステージクリアです。岩などの障害物に当たっている間やスタミナが`0`の間は走れなくなり、速度がゆっくりになります。
